    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node_title', models.CharField(blank=True, max_length=200)),
                ('node_content', models.CharField(blank=True, max_length=10000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporting_username', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='tellmeastory.user')),
            ],
        ),
        migrations.CreateModel(
            name='Reaction',
